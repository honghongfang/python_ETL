...
logs_output_csv_file_name = \
    f"logs-{time.strftime('%Y-%m-%d_%H', time.localtime())}.csv"
...
# 商品数据写出 csv 根路径
barcode_output_csv_root_path = "D:/etl/output/barcode/"
# 商品数据写出 csv 文件名
...
# 订单数据写出 csv 的根路径
retail_output_csv_root_path = "D:/etl/output/orders/"
# 每一次运行，订单文件写出路径
